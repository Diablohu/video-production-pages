            ...
            <div className="changes">
                <div className="contents">
                    ...
                    <ul>
                        ...
                        <li>
                            为解决当使用飞行控制器时屏幕上出现的不正常的“白点”和“白框”的现象，添加2个相关的“可用性”选项，其默认设置将会还原为
                            AAU_02 版本之前的行为
                        </li>
                    </ul>
                ...
                <div className="contents">
                    ...
                    <ul>
                        <li>
                            <strong>787-10</strong>
                            <ul>
                                <li>实装 EFB，可进行起飞性能计算</li>
                                <li>FD 开关可控制 HUD 上指引的显示</li>
                            </ul>
                        </li>
                        <li>现支持按计划的阶段式爬升</li>
                        <li>整体优化航电内检查单，更贴近现实</li>
                        <li>
                            起飞时如果升降舵配平不正确，EICAS 会显示相应警告
                        </li>
                        <li>优化自动驾驶的 LOC 截获行为，以减少飞过头的情况</li>
                        <li>修正在外部视角时自动驾驶乱飞的问题</li>
                        <li>小幅优化刹车性能</li>
                        <li>
                            以及其他总计 <strong>100</strong> 余条改进
                            <br />
                            推荐感兴趣的朋友详读补丁说明
                        </li>
                    </ul>
