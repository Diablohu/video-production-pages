    ...
    cells: [
        ...
        },
        {
            ...
            infos: [
                {
                    type: 'new',
                    content: <>【气流可视化】显示湍流来源</>,
                },
                {
                    type: 'new',
                    content: '【气流可视化】显示下沉气流',
                },
                '【直升机CFD】加大涡环效应',
            ],
            columnSpan: 7,
...
const cellGroupAircrafts: CellGroupType = {
    ...
    cells: [
        ...
        },
        {
            // implemented: false,
            title: '波音 307',
            infos: ['完全重做，支持生涯', '开发转移到 iniBuilds'],
            columnSpan: 6,
        ...
        },
        {
            ...
            infos: ['大量细节修复（未进驻生涯）'],
            columnSpan: 4,
            img: require('../202605-su05+aau04/imgs/FSWeekend 2026 LIVE on the FSElite Stage (SATURDAY 21st March 2026).mp4_20260409_020226.590.png'),
